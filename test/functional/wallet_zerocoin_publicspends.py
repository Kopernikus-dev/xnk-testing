...
class ZerocoinSpendTest(EncoCoinTestFramework):
    ...
    def run_test(self):
        ...
        zxnk_balance, balance = check_balances(denom_2, zxnk_balance, balance)
        ...
        block_time = stake_4_blocks(block_time)
        self.check_tx_in_chain(0, txid)
        zxnk_balance, balance = check_balances(denom_3, zxnk_balance, balance)
        ...
        _, _ = check_balances(denom_1, zxnk_balance, balance)
        self.log.info("--> VALID PUBLIC COIN SPEND (v3) PASSED")
