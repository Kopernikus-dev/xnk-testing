...
class WalletSaplingTest(EncoCoinTestFramework):
    ...
    def run_test(self):
        ...
        tx_json = self.nodes[0].raw_shieldsendmany("from_shield", recipients5, 1, fee)
        ...
        # Verify balance
        assert_equal(self.nodes[0].getshieldbalance(saplingAddr0), Decimal('3'))   # 30 received - (20 sent + 3 fee)
