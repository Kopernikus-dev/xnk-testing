...
from test_framework.test_framework import EncoCoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(EncoCoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.EncoCoin.org/t/test-proposal"
