...
class ListReceivedTest (EncoCoinTestFramework):
    ...
    def run_test_release(self, height): # starts in height 214
        ...
        txid = self.nodes[1].shieldedsendmany(taddr, [ # node_1 with 6 XNK sending them all (fee is 0.0001 XNK)
        ...
        txid = self.nodes[1].shieldedsendmany(shield_addr1, # shield_addr1 has 2 XNK, send 0.6 XNK + 0.0001 XNK fee
