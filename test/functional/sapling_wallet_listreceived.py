...
class ListReceivedTest (EncoCoinTestFramework):
    ...
    def run_test_release(self, height): # starts in height 214
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 XNK.
        self.generate_and_sync(height+2)

        # Send 1 XNK to shield addr1
        txid = self.nodes[1].shielded_sendmany(taddr, [ # node_1 with 6 XNK sending them all (fee is 0.0001 XNK)
        ...
        # Confirm transaction (2 XNK from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shielded_sendmany(shield_addr1, # shield_addr1 has 2 XNK, send 0.6 XNK + 0.0001 XNK fee
