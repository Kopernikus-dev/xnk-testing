...
class ListReceivedTest (EncoCoinTestFramework):
    ...
    def run_test(self):
        ...
        txid = self.nodes[1].shieldedsendmany(taddr, [ # node_1 with 6 XNK sending them all (fee is 0.1 XNK)
        ...
        txid = self.nodes[1].shieldedsendmany(shield_addr1, # shield_addr1 has 2 XNK, send 0.6 XNK + 0.5 XNK fee
