...
class BudgetProposalTest(EncoCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid EncoCoin address")
        assert_raises_rpc_error(-5, "Invalid EncoCoin address", self.nodes[0].preparebudget,
