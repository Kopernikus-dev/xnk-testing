...
class TxnMallTest(EncoCoinTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to send 1240 * 5 XNK to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 XNK coin each
        ...
        # Node0's balance should be starting balance, plus 50XNK for another
        ...
        # Node0's total balance should be starting balance, plus 100XNK for
