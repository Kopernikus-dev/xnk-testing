...
class SaplingMempoolTest(EncoCoinTestFramework):
    ...
    def run_test(self):
        ...
        rawTx = alice.raw_shieldsendmany(alice_zaddr, [{"address": tadd_A, "amount": Decimal('9.00')}], 1, fee)
        ...
        txC_json = alice.raw_shieldsendmany(alice_zaddr, [{"address": tadd_C, "amount": Decimal('9.00')}], 1, fee)
