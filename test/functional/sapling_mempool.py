...
class SaplingMempoolTest(EncoCoinTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 XNK note to Alice
        ...
        rawTx = alice.raw_shieldedsendmany(alice_zaddr, [{"address": tadd_A, "amount": Decimal('9.00')}], 1, fee)
        ...
        # miner sends another 10 XNK note to Alice
        ...
        txC_json = alice.raw_shieldedsendmany(alice_zaddr, [{"address": tadd_C, "amount": Decimal('9.00')}], 1, fee)
