...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            EncoCoinGUI* window = static_cast<EncoCoinGUI*>(parentWidget());
...
{
    EncoCoinGUI* gui = static_cast<EncoCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<EncoCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
