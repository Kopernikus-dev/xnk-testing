...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZxnk = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZxnk = false);
