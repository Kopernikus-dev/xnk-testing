...
#include "qt/encocoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(EncoCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &EncoCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
