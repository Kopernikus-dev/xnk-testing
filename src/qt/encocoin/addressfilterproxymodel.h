...
#ifndef EncoCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define EncoCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //EncoCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
