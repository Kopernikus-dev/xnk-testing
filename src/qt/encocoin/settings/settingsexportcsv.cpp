...
#include "qt/encocoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(EncoCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("EncoCoin_tx_csv_export(*.csv)") : tr("EncoCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
