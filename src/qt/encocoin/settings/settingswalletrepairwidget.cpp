...
#include "qt/encocoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/encocoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(EncoCoinGUI* _window, QWidget *parent) :
