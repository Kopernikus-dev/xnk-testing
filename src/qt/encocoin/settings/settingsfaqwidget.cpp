...
#include "qt/encocoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/encocoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(EncoCoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableXNK,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableXNK,
    ...
    connect(ui->pushButton_UnspendableXNK, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableXNK);});
