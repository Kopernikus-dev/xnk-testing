...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, EncoCoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, EncoCoinGUI* gui, double posX = 3);
