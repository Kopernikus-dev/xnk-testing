...
#include "qt/encocoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(EncoCoinGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-encocoin");
