...
UniValue sendmany(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "\nSend to multiple destinations. Recipients are transparent or shield EncoCoin addresses.\n"
            ...
            "    {\n"
            "      \"address\":amount   (numeric) The encocoin address (either transparent or shield) is the key,\n"
