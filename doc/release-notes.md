EncoCoin Core *3.2.0* is now available from:  <https://github.com/encocoin-project/encocoin/releases>
...
PIVX Core v4.0.0 is a mandatory update for all users. This release contains a protocol upgrade (to `70920`), new consensus rules and improvements that are not backwards compatible with older versions. Users will need to update their clients before enforcement of this update goes into effect.
...
The 'account' API was deprecated in v3.1.0, and has been fully removed in v4.0.0.
The 'label' API was introduced in v3.1.0 as a replacement for accounts.
